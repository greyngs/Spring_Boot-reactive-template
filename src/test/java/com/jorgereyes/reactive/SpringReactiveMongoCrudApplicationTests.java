package com.jorgereyes.reactive;

import com.jorgereyes.reactive.controller.ProductController;
import com.jorgereyes.reactive.dto.ProductDto;
import com.jorgereyes.reactive.service.ProductService;
...
class SpringReactiveMongoCrudApplicationTests {
	...
	public void getProductsTest(){
		Flux<ProductDto> productDtoFlux = Flux.just(
				...
				new ProductDto("104", "Book", 1, 1000));
		...
		StepVerifier.create(responseBody)
				...
				.expectNext(new ProductDto("104", "Book", 1, 1000))
				.verifyComplete();
	}
